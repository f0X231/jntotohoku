	...
	<section id="info-iwate" class="container is-widescreen">
		...
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["IWATE_WEBSITE_LINK"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["IWATE_WAY_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["IWATE_ADDR_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["IWATE_GPS_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
	...
	<section id="gallery" class="container is-widescreen">
		...
		<div>
			<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
				<li data-thumb="src/images/gallery/iwate1.jpg"> 
					<img src="src/images/gallery/iwate1.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/iwate2.jpg"> 
					<img src="src/images/gallery/iwate2.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/iwate3.jpg"> 
					<img src="src/images/gallery/iwate3.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/iwate4.jpg"> 
					<img src="src/images/gallery/iwate4.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/iwate5.jpg"> 
					<img src="src/images/gallery/iwate5.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/iwate6.jpg"> 
					<img src="src/images/gallery/iwate6.jpg" class="is-fullwidth" />
				</li>
			</ul>
		</div>
		<br />
