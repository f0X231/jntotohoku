	...
	<section id="info-miyagi" class="container is-widescreen">
		...
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width90">
				...
				<p><?php echo $language["MIYAGI_WEBSITE_LINK"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width90">
				...
				<p><?php echo $language["MIYAGI_WAY_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width90">
				...
				<p><?php echo $language["MIYAGI_ADDR_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width90">
				...
				<p><?php echo $language["MIYAGI_GPS_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
