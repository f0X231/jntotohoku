...
<head>
	...
	<title><?php echo $language["TOHOKUART_META_TITLE"]; ?></title>

	<meta name="description" content="<?php echo $language["TOHOKUART_META_DESCRIPTION"]; ?>">
	<meta name="keywords" content="<?php echo $language["TOHOKUART_META_KEYWORD"]; ?>">

	<!-- Open Graph data -->
	<meta property="og:title" content="<?php echo $language["TOHOKUART_META_TITLE"]; ?>" />
	<meta property="og:description" content="<?php echo $language["TOHOKUART_META_DESCRIPTION"]; ?>" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="/AKITA" />
	<meta property="og:site_name" content="<?php echo $language["TOHOKUART_META_SITENAME"]; ?>" />
	<meta property="og:image" content="<?php echo $language["TOHOKUART_META_IMAGE"]; ?>" />
	
	<!-- Twitter Card data -->
	<meta name="twitter:card" value="summary">
	<meta name="twitter:title" content="<?php echo $language["TOHOKUART_META_TITLE"]; ?>">
	<meta name="twitter:description" content="<?php echo $language["TOHOKUART_META_DESCRIPTION"]; ?>">
	<meta name="twitter:image" content="<?php echo $language["TOHOKUART_META_IMAGE"]; ?>">
...
<body>
    ...
    <section id="arts-vdo" class="container is-widescreen bgsnow">
		...
		<div class="video-container">
			<iframe width="853" height="480" src="https://www.youtube.com/embed/MnviD4gCg3I" frameborder="0" allowfullscreen></iframe>
		</div>
		<br />
	</section>
	...
	<section id="arts-lcation-1" class="container is-widescreen">
		...
		<p class="is-size-4 has-text-weight-bold has-text-centered"><?php echo $language["TOHOKUART_HEAD_LOCATION_NAME"]; ?></p>
		<br />
    ...
    <section id="arts-lcation-4" class="container is-widescreen">
        ...
        <p class="is-size-4 has-text-weight-bold has-text-centered"><?php echo $language["TOHOKUART_HEAD_LOCATION_NAME5"]; ?></p>
        <br />
	...
	<section id="tips" class="container is-widescreen">
		<div><a href="tohoku.php" target="_blank"><img src="src/images/tips1.jpg" width="100%" /></a></div>
