...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<title><?php echo $language["AOMORI_META_TITLE"]; ?></title>

	<meta name="description" content="<?php echo $language["AOMORI_META_DESCRIPTION"]; ?>">
	<meta name="keywords" content="<?php echo $language["AOMORI_META_KEYWORD"]; ?>">

	<!-- Open Graph data -->
	<meta property="og:title" content="<?php echo $language["AOMORI_META_TITLE"]; ?>" />
	<meta property="og:description" content="<?php echo $language["AOMORI_META_DESCRIPTION"]; ?>" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="/AOMORI" />
	<meta property="og:site_name" content="<?php echo $language["AOMORI_META_SITENAME"]; ?>" />
	<meta property="og:image" content="<?php echo $language["AOMORI_META_IMAGE"]; ?>" />
	
	<!-- Twitter Card data -->
	<meta name="twitter:card" value="summary">
	<meta name="twitter:title" content="<?php echo $language["AOMORI_META_TITLE"]; ?>">
	<meta name="twitter:description" content="<?php echo $language["AOMORI_META_DESCRIPTION"]; ?>">
	<meta name="twitter:image" content="<?php echo $language["AOMORI_META_IMAGE"]; ?>">
...
<body>
	<section id="herobanner" class="container is-widescreen">
		...
		<div class="owl-carousel owl-theme">
			<div class="item"><a href=""><img src="src/images/banner/hero_banner_aomori.jpg" alt=""></a></div>
		</div>
		<br /><br />
	</section>

	<section id="info-aomori" class="container is-widescreen">
		<h1 class="is-size-3 has-text-weight-bold"><?php echo $language["AOMORI_INFO_TITLE"]; ?></h1>
		<br />
		<p class="is-size-4"><?php echo $language["AOMORI_INFO_DETAIL"]; ?></p>
		<br />
		<br />
	...
	<section id="gallery" class="container is-widescreen">
		...
		<p class="is-size-4 has-text-centered"><?php echo $language["AOMORI_GALLERY_INFO"]; ?></p>
		<br />
		<div>
			<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
				<li data-thumb="src/images/gallery/aomori1.jpg"> 
					<img src="src/images/gallery/aomori1.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/aomori2.jpg"> 
					<img src="src/images/gallery/aomori2.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/aomori3.jpg"> 
					<img src="src/images/gallery/aomori3.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/aomori4.jpg"> 
					<img src="src/images/gallery/aomori4.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/aomori5.jpg"> 
					<img src="src/images/gallery/aomori5.jpg" class="is-fullwidth" />
				</li>
				<li data-thumb="src/images/gallery/aomori6.jpg"> 
					<img src="src/images/gallery/aomori6.jpg" class="is-fullwidth" />
				</li>
			</ul>
		</div>
		<br />
