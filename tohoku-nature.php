...
<head>
	...
	<title><?php echo $language["TOHOKUNT_META_TITLE"]; ?></title>

	<meta name="description" content="<?php echo $language["TOHOKUNT_META_DESCRIPTION"]; ?>">
	<meta name="keywords" content="<?php echo $language["TOHOKUNT_META_KEYWORD"]; ?>">

	<!-- Open Graph data -->
	<meta property="og:title" content="<?php echo $language["TOHOKUNT_META_TITLE"]; ?>" />
	<meta property="og:description" content="<?php echo $language["TOHOKUNT_META_DESCRIPTION"]; ?>" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="/AKITA" />
	<meta property="og:site_name" content="<?php echo $language["TOHOKUNT_META_SITENAME"]; ?>" />
	<meta property="og:image" content="<?php echo $language["TOHOKUNT_META_IMAGE"]; ?>" />
	
	<!-- Twitter Card data -->
	<meta name="twitter:card" value="summary">
	<meta name="twitter:title" content="<?php echo $language["TOHOKUNT_META_TITLE"]; ?>">
	<meta name="twitter:description" content="<?php echo $language["TOHOKUNT_META_DESCRIPTION"]; ?>">
	<meta name="twitter:image" content="<?php echo $language["TOHOKUNT_META_IMAGE"]; ?>">
...
<body>
	<section id="herobanner" class="container is-widescreen">
		...
		<div class="owl-carousel owl-theme">
			<div class="item"><a href=""><img src="src/images/banner/hero_banner_tohoku_nature.jpg" alt=""></a></div>
		</div>
		<br />
		<h1 class="is-size-4 has-text-weight-bold has-text-centered"><?php echo $language["TOHOKUNT_INFO_HEAD"]; ?></h1>
		<p class="is-size-4 has-text-centered"><?php echo $language["TOHOKUNT_INFO"]; ?></p>
		<br />
    ...
    <section id="artist-vdo" class="container is-widescreen bgsnow">
		...
		<div class="video-container">
			<iframe width="853" height="480" src="https://www.youtube.com/embed/ua0jimMUytQ" frameborder="0" allowfullscreen></iframe>
		</div>
		<br />
	</section>


	<section id="nature-location-1" class="container is-widescreen">
        <h2 class="is-size-3 has-text-weight-bold has-text-centered"><?php echo $language["TOHOKUNT_LOCATION"]; ?></h2>
		<p class="is-size-4 text-weight-bold has-text-centered"><?php echo $language["TOHOKUNT_LOCATION_NAME"]; ?></p>
        <br />
		<img src="src/images/theme/themeNature1.jpg" width="100%" />
		<br />
        <p class="is-size-4 lineheight1-5"><?php echo $language["TOHOKUNT_LOCATION_TXT1"]; ?></p>
		<br /><br />
    </section>
