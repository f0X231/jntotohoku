	...
	<section id="info-fukushima" class="container is-widescreen">
		...
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["FUKUSHIMA_WEBSITE_LINK"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["FUKUSHIMA_ADDR_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["FUKUSHIMA_GPS_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
