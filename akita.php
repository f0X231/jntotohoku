	...
	<section id="info-akita" class="container is-widescreen">
		...
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["AKITA_WEBSITE_LINK"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["AKITA_WAY_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["AKITA_ADDR_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
		<div class="info-table is-size-4 allClear">
			...
			<div class="is-pulled-left width85">
				...
				<p class="breakSentence"><?php echo $language["AKITA_GPS_DETAIL"]; ?></p>
			</div>
		</div>
		<br />
