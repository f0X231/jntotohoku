...
<head>
	...
	<title><?php echo $language["TOHOKUSPE_META_TITLE"]; ?></title>

	<meta name="description" content="<?php echo $language["TOHOKUSPE_META_DESCRIPTION"]; ?>">
	<meta name="keywords" content="<?php echo $language["TOHOKUSPE_META_KEYWORD"]; ?>">

	<!-- Open Graph data -->
	<meta property="og:title" content="<?php echo $language["TOHOKUSPE_META_TITLE"]; ?>" />
	<meta property="og:description" content="<?php echo $language["TOHOKUSPE_META_DESCRIPTION"]; ?>" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="/AKITA" />
	<meta property="og:site_name" content="<?php echo $language["TOHOKUSPE_META_SITENAME"]; ?>" />
	<meta property="og:image" content="<?php echo $language["TOHOKUSPE_META_IMAGE"]; ?>" />
	
	<!-- Twitter Card data -->
	<meta name="twitter:card" value="summary">
	<meta name="twitter:title" content="<?php echo $language["TOHOKUSPE_META_TITLE"]; ?>">
	<meta name="twitter:description" content="<?php echo $language["TOHOKUSPE_META_DESCRIPTION"]; ?>">
	<meta name="twitter:image" content="<?php echo $language["TOHOKUSPE_META_IMAGE"]; ?>">
...
<body>
	<section id="herobanner" class="container is-widescreen">
		...
		<div class="owl-carousel owl-theme">
			<div class="item"><a href=""><img src="src/images/banner/hero_banner_tohoku_special.jpg" alt=""></a></div>
		</div>
		<br />
		<h1 class="is-size-3 has-text-weight-bold has-text-centered"><?php echo $language["TOHOKUSPE_INFO_HEAD"]; ?></h1>
		<p class="is-size-4 has-text-centered"><?php echo $language["TOHOKUSPE_INFO"]; ?></p>
		<br />
	...
	<section id="special-vdo" class="container is-widescreen bgsnow">
		...
		<div class="video-container">
			<iframe width="853" height="480" src="https://www.youtube.com/embed/WVkRHqxy1V8" frameborder="0" allowfullscreen></iframe>
		</div>
		<br />
	</section>
	...
	<section id="special-location-1" class="container is-widescreen">
		...
		<p class="is-size-4 text-weight-bold has-text-centered"><?php echo $language["TOHOKUSPE_HEAD_LOCATION_NAME"]; ?></p>
		<br />
    ...
    <section id="special-location-3" class="container is-widescreen">
        ...
        <p class="is-size-4 text-weight-bold has-text-centered"><?php echo $language["TOHOKUSPE_HEAD_LOCATION_NAME5"]; ?></p>
        <br />
