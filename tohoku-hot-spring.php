...
<body>
	...
	<div class="herobanner-bar width100 allClear">
		...
		<br />
		<h1 class="is-size-4 has-text-weight-bold has-text-centered"><?php echo $language["TOHOKUHOT_INFO_HEAD"]; ?></h1>
    ...
    <section id="hotspring-vdo" class="container is-widescreen bgsnow">
		...
		<div class="video-container">
			<iframe width="853" height="480" src="https://www.youtube.com/embed/gHiczuFt0po" frameborder="0" allowfullscreen></iframe>
		</div>
		<br />
	</section>
	...
	<section id="hotspring-location-1" class="container is-widescreen">
		...
		<p class="is-size-4 text-weight-bold has-text-centered"><?php echo $language["TOHOKUHOT_LOCATION_NAME"]; ?></p>
		<br />
